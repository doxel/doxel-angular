      ...
      , f = {
        ...
        addClass: function(a, d) {
            if (void 0 === a.className)
                ...
                a.className = b.join(" ").replace(/^\s+/, "").replace(/\s+$/, ""))
            }
            return f
        },
...
dat.GUI = dat.gui.GUI = function(e, a, b, d, f, c, p, k, l, q, n, r, y, g, h) {
    function t(a, c, b, e) {
        ...
        e.color ? c = new n(c,b) : (c = [c, b].concat(e.factoryArgs),
        c = d.apply(a, c));
    ...
    function s(a, d, b) {
        ...
        if (b instanceof l) {
            ...
            var f = function(d) {
                return h.isNumber(b.__min) && h.isNumber(b.__max) ? (b.remove(),
                t(a, b.object, b.property, {
                    before: b.__li.nextElementSibling,
            ...
            })) : b instanceof n && (g.addClass(d, "color"),
    ...
    function v(a, d) {
        ...
        if (-1 != c) {
            ...
            void 0 === e && (e = {},
            b.__rememberedObjectIndecesToControllers[c] = e);
            e[d.property] = d;
            if (b.load && b.load.remembered) {
                ...
                if (b[a.preset])
                    ...
                    return;
                b[c] && void 0 !== b[c][d.property] && (c = b[c][d.property],
                d.initialValue = c,
                d.setValue(c))
            }
        }
    ...
    function K(a) {
        ...
        a.load && a.load.remembered ? h.each(a.loademembered, function(b, d) {
            E(a, d, d == a.preset)
        }) : E(a, z, !1);
    ...
    var A, H = !0, x, C = !1, I = [], m = function(a) {
        ...
        Object.defineProperties(this, {
            ...
            useLocalStorage: {
                ...
                set: function(a) {
                    w && ((e = a) ? g.bind(window, "unload", b) : g.unbind(window, "unload", b),
        ...
        if (h.isUndefined(a.parent)) {
            ...
            this.__closeButton.innerHTML = a.closed ? m.TEXT_OPEN : m.TEXT_CLOSE;
        ...
        a.autoPlace && (h.isUndefined(a.parent) && (H && (x = document.createElement("div"),
        g.addClass(x, "dg"),
    ...
    h.extend(m.prototype, {
        ...
        onResize: function() {
            ...
            if (a.scrollable) {
                ...
                window.innerHeight - b - 20 < d ? (g.addClass(a.domElement, m.CLASS_TOO_TALL),
        ...
        remember: function() {
            h.isUndefined(A) && (A = new y,
            A.domElement.innerHTML = a);
            if (this.parent)
    ...
    var k = function(e, n) {
        ...
        function g() {
            var a = d(this.value);
            !1 !== a ? (s.__color.__state = a,
            s.setValue(s.__color.toOriginal())) : this.value = s.__color.toString()
        }
        function h() {
    ...
    function f(a, b, d) {
        Object.defineProperty(a, b, {
            ...
            set: function(a) {
                "RGB" !== this.__state.space && (p(this, b, d),
